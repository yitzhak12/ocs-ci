...
def patch_storagecluster_mon_healthcheck(mon_timeout, mon_interval="20s", sc_obj=None):
    ...
    Args:
        ...
        sc_obj (OCP): StorageCluster. If None, it will be fetched.
...
def delete_storagecluster_mon_healthcheck(sc_obj=None):
    ...
    Args:
        sc_obj (OCP): StorageCluster object. If None, it will be fetched.
...
def verify_mon_healthcheck_consistency(sc_obj=None, cc_obj=None):
    ...
    Args:
        sc_obj (OCP): StorageCluster object from OCP.get(). If None, it will be fetched.
        cc_obj (object): CephCluster object from OCP.get(). If None, it will be fetched.
...
def wait_for_mon_healthcheck_timeout_in_logs(
    ...
    Returns:
        list[str]: A list of matched log lines containing the timeout message.
    ...
    Example:
        # wait_for_mon_healthcheck_timeout_in_logs("c")
        The function returns log lines similar to:
        [
